...
function Tuition(props){
    ...
    const tuitionNote = {
        "us":{ "title":"Note to International Students:", "text":["One course at LGCU consists of 3 credit hours. Therefore, if the cost of one course is $100 per credit hour, the total cost for the course is $300.","If the degree which you have chosen has 10 courses, the total cost for that degree will be the total cost of 1 course multiplied by the total number of courses to complete the degree; for example: ($300x 10)."] },
        "fr":{ "title":"Note aux étudiants internationaux:", "text":["Un cours à LGCU comprend 3 heures de crédit. Par exemple, si le coût d'un cours est de 100 $ par heure de crédit, le coût total du cours est de 300 $.","Si le diplôme que vous avez choisi contient 10 cours, le coût total de ce diplôme sera le coût total d'un cours multiplié par le nombre total des cours pour compléter le diplôme; par exemple: (($300 x10)."] },
        "es":{ "title":"Nota para estudiantes internacionales:", "text":["un curso en LGCU consta de 3 horas de crédito. Por lo tanto, si el costo de un curso es de $100 por hora de crédito, el costo total del curso es de $ 300.", "Si el título que ha elegido tiene 10 cursos, el costo total de ese título será el costo total de 1 curso multiplicado por el número total de cursos para completar el título; por ejemplo: ($ 300 x10)."] }
    };
        ...
        <div className="inner-page-body tuitionPage">
            <section className="tuition-section">
                ...
                <div className="section-container">
                    <p>Lenkeson Global Christian University is a non-profit institution of higher learning established to provide affordable education to individuals who otherwise could not afford it.  LGCU's tuition is among some of the lowest online universities in the United States. Payment plans at Lenkeson Global Christian University make earning a degree convenient and affordable. For more information, please contact the Business Office at 407-567-1942 or email us at <a href="mailto:lenkeson8@gmail.com">lenkeson8@gmail.com</a>.</p>
